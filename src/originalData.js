...
// functions used to generate formated data
 ...
 const getRegCollections = collections => {
  ...
  //console.log(JSON.stringify(getCollections(regCollections)) )
  ...
  //console.log(JSON.stringify(getNames(regCollections)) )
  ...
  //console.log(JSON.stringify(getProfiles(regCollections)) )
